    ...
    static void Main()
    {
        ...
        else if (sugarLevel >= 4.5 && sugarLevel <= 8.4)
        {
            ...
            if (aboutToEat == "y")
            {
                ...
                Console.ResetColor();
                Console.WriteLine($" units of insulin for your meal if you want your blood sugar levels to remain at {sugarLevel}.");
            }
        ...
        else if (sugarLevel >= 8.5)
        {
            ...
            if (aboutToEat == "y")
            {
                ...
                Console.Write($"{insulinToTake}");
                Console.ResetColor();
                Console.WriteLine($" units of insulin for your meal if you want your blood sugar level remain at {sugarLevel}");
                Console.ForegroundColor = ConsoleColor.Red;
